...
export default function Charseczen(){
    return(
        <nav class = "seczen">
            <div class = "zenpg">`</div>
            <a class = "gryscl1" href="http://localhost:3000/chars" ><img src = {sechi3l}></img></a>
            <a class = "gryscl1" href="http://localhost:3000/gichars" ><img src = {secgil}></img></a>
            <a class = "hstrl1" href="http://localhost:3000/zenchars"><img src = {seczzzl}></img> </a>
